...
public class TestLightViewer {
    private GUI gui;
    private LightViewer viewer;
    private Board board;
    ...
    void drawBoard() throws IOException {
        viewer.draw(gui);
        Mockito.verify(gui, Mockito.times(1)).drawBoard(tetris.getBoard(),"#ffffff", "#fffafa", "#f5f5f5",false);
    }
